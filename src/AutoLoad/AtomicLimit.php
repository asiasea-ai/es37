...
class AtomicLimit
{
    ...
    public function autoLoad()
    {
        try {
            ...
            $atomicLimit->attachServer(ServerManager::getInstance()->getSwooleServer(), EsConst::ES_DI_AUTO_LIMITER);
            Di::getInstance()->set(EsConst::ES_DI_AUTO_LIMITER, $atomicLimit);
